...
function saludo(nombre:string):string {// despues del parametro se puede indicar el tipo de dato del return
...
function mostrarPais(pais:string = "Chile", continente?:string):string { // continente? indica que es un parametro opcional
